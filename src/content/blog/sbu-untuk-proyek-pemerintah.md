---
title: "SBU untuk Proyek Pemerintah: Syarat e-Procurement 2026"
...
faqSchema:
  - q: "Apakah SBU wajib untuk proyek pemerintah melalui LPSE?"
    a: "Ya, SBU adalah syarat mutlak untuk mengikuti pengadaan jasa konstruksi pemerintah melalui LPSE (Layanan Pengadaan Secara Elektronik). Sistem LPSE terintegrasi dengan database LPJK dan akan menolak otomatis peserta yang SBU-nya tidak aktif atau tidak sesuai sub-bidang. Tidak ada pengecualian dari panitia tender — verifikasi dilakukan sistem, bukan manusia."
  - q: "Bagaimana LPSE memverifikasi SBU peserta tender?"
    a: "LPSE terintegrasi dengan Sistem Informasi Jasa Konstruksi (SIJK) LPJK. Saat kontraktor mendaftar di LPSE, nomor SBU yang dicantumkan akan dicek secara real-time: apakah terdaftar, aktif, sub-bidangnya cocok, dan masa berlakunya cukup untuk durasi proyek. Penolakan otomatis terjadi kalau salah satu dari kondisi ini tidak terpenuhi. Berdasarkan pengalaman Atrahdis, kesalahan nomor SBU atau typo saja sudah cukup membuat pendaftaran gagal."
...
1. **Pendaftaran tender** — kontraktor input nomor SBU saat daftar
2. **Validasi real-time** — LPSE cek ke database LPJK
3. **Sistem memeriksa 4 hal:**
...
4. **Kalau semua cocok** — pendaftaran diterima, lanjut ke upload dokumen
5. **Kalau ada yang tidak cocok** — pendaftaran ditolak otomatis, tidak bisa lanjut
...
1. **NIB aktif** — sinkron dengan SBU
2. **NPWP** dan status pajak (SPT Tahunan 3 tahun terakhir)
3. **Akta perusahaan** terbaru
4. **Neraca keuangan** audited (untuk M dan B)
5. **Pengalaman proyek sejenis** — 5 tahun terakhir, relevan sub-bidang
6. **Sertifikat SMK3** — beberapa K/L mensyaratkan ini untuk paket tertentu
7. **ISO 9001** — opsional tetapi sering dijadikan nilai tambah
...
Untuk memahami syarat tender secara lebih mendalam, baca [syarat tender konstruksi SBU K/M/B](/blog/syarat-tender-konstruksi-sbu). Untuk mencegah SBU expired saat proyek berjalan, baca [perpanjangan SBU sebelum expired](/blog/perpanjangan-sbu-sebelum-expired). Kalau ingin audit SBU Anda sekarang, cek layanan [SBU Menengah](/layanan/sbu-menengah) atau [SBU Besar](/layanan/sbu-besar).
